...
.board_button { clear:both; margin:90px 0 0 0; display:inline-block; width:100%; }
...
#GalleryUl > li { float:left; width:350px; height:235px; margin:0 0 20px 6.2%; position:relative; }
...
.GU_con { float:left; width:100%; box-sizing:border-box; padding:20px 20px; }
.GU_subj { width:100%; font-size:16px; color:#222; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; text-align:center; padding-bottom:10px; }
/*
.GU_subj {
